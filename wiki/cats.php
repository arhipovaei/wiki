<?php
	...
	$param_keys=array('name'); // названия полей в таблице БД
	$param_str=array('Наименование'); // названия столбцов в таблице для отображения
	$param_ext=array(0); // поля для select
